  ...
  <div class="container-fluid">
    <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                ...
                <a class="navbar-brand" href="./index.php?id=<?php echo $_SESSION['empid']?>"><img src="img/logo.png" style="height: 30px; margin-left: 15px;"></a>
        </div>
  ...
  <div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Sign in as Manager</h1>
            <div class="account-wall">
                <img class="profile-img" src="img/user.png" alt="">
                
                <form class="form-signin" action="managerdb.php" method="POST">
                <div>
                <input type="text" class="form-control" name="id" placeholder="Enter User ID" value="<?php echo base64_decode($_GET['id']); ?>" required autofocus>
                </div>
                <div>
