<?php 
   include "connection.php";
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO manager (`userid`, `managername`, `password`) VALUES ('$userid', '$managername', '$password') ";
  ...
  <div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">SignUp Manager</h1>
            <div class="account-wall">
                <img class="profile-img" src="img/user.png" alt="">
                
                <form class="form-signin" action="" method="POST">
                <div>
                <input type="text" class="form-control" name="id" placeholder="Enter manager ID" required autofocus>
                </div>
                <div>
                <input type="text" class="form-control" name="managername" placeholder="Manager Name" required autofocus>
                </div>
                <div>
